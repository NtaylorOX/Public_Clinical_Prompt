...
# set data directory containing train-test splits
...
dataset['train'] = MimicProcessor().get_examples(data_dir = mimic_data_dir, mode = "train")[:10000]
dataset['validation'] = MimicProcessor().get_examples(data_dir = mimic_data_dir, mode = "valid")[:500]
dataset['test'] = MimicProcessor().get_examples(data_dir = mimic_data_dir, mode = "test")[:500]
